...
const CustomerList = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Registered Customers | Marathon Noida Admin</title>
        <meta
          name="description"
          content="View all registered customers for the Marathon Noida event. Admin panel for customer management."
        />
        <meta
          name="keywords"
          content="Registered Customers, Marathon Noida, Admin Panel, Event Registration"
        />
        <meta
          property="og:title"
          content="Registered Customers - Marathon Noida Admin"
        />
        <meta
          property="og:description"
          content="Admin panel showing all registered customers for Marathon Noida event."
        />
        <meta
          property="og:image"
          content="http://localhost:3000/static/media/one-nation-one-election.8644d508a6f54d6817a6.png" 
        />
